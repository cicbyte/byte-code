...
const productTabs: NavTab[] = [
  { key: 'overview', label: '概览', path: '/product/:productId/overview' },
  { key: 'requirements', label: '需求', path: '/product/:productId/requirements' },
  { key: 'milestones', label: '里程碑', path: '/product/:productId/milestones' },
];

export const entityNavConfigs: Record<string, EntityNavConfig> = {
  project: { basePath: '/project', tabs: projectTabs },
  product: { basePath: '/product', tabs: productTabs },
};
